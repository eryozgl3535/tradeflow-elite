...
const TR = {
  ...
  hatirlatma:"Hatırlatma",faturaKes:"Proforma Oluştur",tamamla:"Tamamla",kapat:"Kapat",
  ...
  donemSon3Ay:"Son 3 Ay",donemBuYil:"Bu Yıl",donemTumu:"Tümü",
  ...
  malzemelerL:"🧰 Kullanılan Malzemeler",opsiyonelEk:"(opsiyonel)",notBaslik:"📝 Not",malzemeListePh:"Örn:\n2x PPR boru 25mm\n1x Kombi contası\n3m kablo",
...
const EN = {
  ...
  hatirlatma:"Reminder",faturaKes:"Create Proforma",tamamla:"Complete",kapat:"Close",
  ...
  donemSon3Ay:"Last 3 Months",donemBuYil:"This Year",donemTumu:"All Time",
  ...
  malzemelerL:"🧰 Materials Used",opsiyonelEk:"(optional)",notBaslik:"📝 Note",malzemeListePh:"e.g.\n2x PPR pipe 25mm\n1x Boiler gasket\n3m cable",
...
const DE = {
  ...
  hatirlatma:"Erinnerung",faturaKes:"Proforma erstellen",tamamla:"Abschließen",kapat:"Schließen",
  ...
  donemSon3Ay:"Letzte 3 Monate",donemBuYil:"Dieses Jahr",donemTumu:"Gesamt",
  ...
  malzemelerL:"🧰 Verwendete Materialien",opsiyonelEk:"(optional)",notBaslik:"📝 Notiz",malzemeListePh:"z.B.\n2x PPR-Rohr 25mm\n1x Kessel-Dichtung",
...
const FR = {
  ...
  hatirlatma:"Rappel",faturaKes:"Créer proforma",tamamla:"Terminer",kapat:"Fermer",
  ...
  donemSon3Ay:"3 derniers mois",donemBuYil:"Cette année",donemTumu:"Tout",
  ...
  malzemelerL:"🧰 Matériaux utilisés",opsiyonelEk:"(facultatif)",notBaslik:"📝 Note",malzemeListePh:"ex.\n2x tube PPR 25mm\n1x joint de chaudière",
...
const ES = {
  ...
  hatirlatma:"Recordatorio",faturaKes:"Crear proforma",tamamla:"Completar",kapat:"Cerrar",
  ...
  donemSon3Ay:"Últimos 3 meses",donemBuYil:"Este año",donemTumu:"Todo",
  ...
  malzemelerL:"🧰 Materiales usados",opsiyonelEk:"(opcional)",notBaslik:"📝 Nota",malzemeListePh:"ej.:\n2x tubo PPR 25mm\n1x junta de caldera",
...
const IT = {
  ...
  hatirlatma:"Promemoria",faturaKes:"Crea proforma",tamamla:"Completa",kapat:"Chiudi",
  ...
  donemSon3Ay:"Ultimi 3 mesi",donemBuYil:"Quest'anno",donemTumu:"Tutto",
  ...
  malzemelerL:"🧰 Materiali usati",opsiyonelEk:"(opzionale)",notBaslik:"📝 Nota",malzemeListePh:"es.\n2x tubo PPR 25mm\n1x guarnizione caldaia",
...
const PT = {
  ...
  hatirlatma:"Lembrete",faturaKes:"Criar proforma",tamamla:"Concluir",kapat:"Fechar",
  ...
  donemSon3Ay:"Últimos 3 meses",donemBuYil:"Este ano",donemTumu:"Tudo",
  ...
  malzemelerL:"🧰 Materiais usados",opsiyonelEk:"(opcional)",notBaslik:"📝 Nota",malzemeListePh:"ex.\n2x tubo PPR 25mm\n1x vedação de caldeira",
...
const NL = {
  ...
  hatirlatma:"Herinnering",faturaKes:"Proforma maken",tamamla:"Afronden",kapat:"Sluiten",
  ...
  donemSon3Ay:"Laatste 3 mnd",donemBuYil:"Dit jaar",donemTumu:"Alles",
  ...
  malzemelerL:"🧰 Gebruikte materialen",opsiyonelEk:"(optioneel)",notBaslik:"📝 Notitie",malzemeListePh:"bijv.\n2x PPR-buis 25mm\n1x ketelpakking",
...
// ═══ EK ÇEVİRİLER — Usta Paneli, Piyasa Şeridi, Masaüstü Karşılama, Günün Sözü (sonradan eklenen özellikler) ═══
const TR2 = {
  ustaIslerim:"İşlerim",ustaHarcama:"Harcama",ustaBitenler:"Bitenler",ustaHesabim:"Hesabım",
  ustaAktifIsim:"Aktif İşim",ustaBugunku:"Bugünkü",ustaBitirdigim:"Bitirdiğim",
  ustaBosIs:"Şu an atanmış açık işin yok. Patronun iş atadığında burada görünecek. 💪",
  ustaBosBiten:"Henüz tamamlanan işin yok — ilk işini bitirince burada listelenecek.",
  rozetCirak:"Çırak",rozetBronz:"Bronz Usta",rozetGumus:"Gümüş Usta",rozetAltin:"Altın Usta",rozetElmas:"Elmas Usta",
  rozetTamamladin:"{n} iş tamamladın",rozetSonraki:"Sonraki",
  statBuHafta:"Bu Hafta",statBuAy:"Bu Ay",statToplam:"Toplam",statTamamlanan:"Tamamlanan",
  gununSozuBaslik:"Günün Sözü",
  soz1:"Ustalık, işi bir kere değil, her seferinde doğru yapmaktır.",
  soz2:"Bugün bıraktığın iz, yarın senin adın olur.",
  soz3:"İyi bir usta aleti değil, işini konuşturur.",
  soz4:"Küçük işler özenle yapılınca büyük güven doğurur.",
  soz5:"Zanaat sabırla, ustalık tekrarla gelir.",
  soz6:"Her tamamlanan iş, bir sonraki için referanstır.",
  soz7:"Temiz iş, temiz isim bırakır.",
  soz8:"En iyi reklam, memnun müşterinin gülüşüdür.",
  soz9:"Detaylara verdiğin önem, seni fark ettirir.",
  soz10:"Bugün de bir eve huzur götürüyorsun.",
  pdfRaporBaslik:"İş Raporumu İndir",pdfRaporAlt:"Tüm işlerin PDF özeti (tutar içermez)",
  desktopSektorunuz:"İş Sektörünüz",desktopSektorSecin:"Sektör seçin…",dunyaSaatleriKisa:"🌍 Dünya saatleri",
  piyasaCanli:"💱 Canlı Piyasa",piyasaCevrimdisi:"çevrimdışı",piyasaYukleniyor:"Piyasa yükleniyor…",
  selamSabah:"Günaydın",altSabah:"Güne erken başlamak iyi gelir.",
  selamOgle:"Tünaydın",altOgle:"Günün ortası — işler nasıl gidiyor?",
  selamAksam:"İyi akşamlar",altAksam:"Günü toparlama vakti.",
  selamGece:"İyi geceler",altGece:"Geç saatte hâlâ iş başında.",
};
const EN2 = {
  ustaIslerim:"My Jobs",ustaHarcama:"Expenses",ustaBitenler:"Completed",ustaHesabim:"My Account",
  ustaAktifIsim:"Active Jobs",ustaBugunku:"Today",ustaBitirdigim:"Completed",
  ustaBosIs:"You have no assigned open jobs right now. New jobs will show up here once your employer assigns them. 💪",
  ustaBosBiten:"No completed jobs yet — they'll appear here once you finish your first one.",
  rozetCirak:"Apprentice",rozetBronz:"Bronze Pro",rozetGumus:"Silver Pro",rozetAltin:"Gold Pro",rozetElmas:"Diamond Pro",
  rozetTamamladin:"{n} jobs completed",rozetSonraki:"Next",
  statBuHafta:"This Week",statBuAy:"This Month",statToplam:"Total",statTamamlanan:"Completed",
  gununSozuBaslik:"Quote of the Day",
  soz1:"Craftsmanship means doing the job right every time, not just once.",
  soz2:"The mark you leave today becomes your name tomorrow.",
  soz3:"A good tradesperson lets the work speak, not the tools.",
  soz4:"Small jobs done with care build big trust.",
  soz5:"Craft comes from patience; mastery comes from repetition.",
  soz6:"Every finished job is a reference for the next one.",
  soz7:"Clean work leaves a clean name.",
  soz8:"The best advertising is a satisfied customer's smile.",
  soz9:"The care you put into details is what makes people notice you.",
  soz10:"Today, you're bringing peace of mind to another home.",
  pdfRaporBaslik:"Download My Job Report",pdfRaporAlt:"PDF summary of all jobs (no amounts included)",
  desktopSektorunuz:"Your Business Sector",desktopSektorSecin:"Choose a sector…",dunyaSaatleriKisa:"🌍 World clocks",
  piyasaCanli:"💱 Live Market",piyasaCevrimdisi:"offline",piyasaYukleniyor:"Loading market data…",
  selamSabah:"Good morning",altSabah:"Starting the day early feels good.",
  selamOgle:"Good afternoon",altOgle:"Midday check-in — how's it going?",
  selamAksam:"Good evening",altAksam:"Time to wrap up the day.",
  selamGece:"Good night",altGece:"Still working at this late hour.",
};
const DE2 = {
  ustaIslerim:"Meine Aufträge",ustaHarcama:"Ausgaben",ustaBitenler:"Erledigt",ustaHesabim:"Mein Konto",
  ustaAktifIsim:"Aktive Aufträge",ustaBugunku:"Heute",ustaBitirdigim:"Erledigt",
  ustaBosIs:"Aktuell sind dir keine offenen Aufträge zugewiesen. Sobald dein Chef dir einen zuweist, erscheint er hier. 💪",
  ustaBosBiten:"Noch keine erledigten Aufträge — sie erscheinen hier, sobald du deinen ersten abschließt.",
  rozetCirak:"Lehrling",rozetBronz:"Bronze-Profi",rozetGumus:"Silber-Profi",rozetAltin:"Gold-Profi",rozetElmas:"Diamant-Profi",
  rozetTamamladin:"{n} Aufträge erledigt",rozetSonraki:"Nächstes",
  statBuHafta:"Diese Woche",statBuAy:"Dieser Monat",statToplam:"Gesamt",statTamamlanan:"Erledigt",
  gununSozuBaslik:"Spruch des Tages",
  soz1:"Handwerk heißt, die Arbeit jedes Mal richtig zu machen, nicht nur einmal.",
  soz2:"Die Spuren, die du heute hinterlässt, werden morgen dein Ruf.",
  soz3:"Ein guter Handwerker lässt die Arbeit sprechen, nicht das Werkzeug.",
  soz4:"Kleine Arbeiten mit Sorgfalt schaffen großes Vertrauen.",
  soz5:"Handwerk kommt aus Geduld, Meisterschaft aus Wiederholung.",
  soz6:"Jeder abgeschlossene Auftrag ist eine Referenz für den nächsten.",
  soz7:"Saubere Arbeit hinterlässt einen sauberen Namen.",
  soz8:"Die beste Werbung ist das Lächeln eines zufriedenen Kunden.",
  soz9:"Die Sorgfalt bei den Details macht dich unverwechselbar.",
  soz10:"Heute bringst du wieder Ruhe in ein Zuhause.",
  pdfRaporBaslik:"Meinen Auftragsbericht herunterladen",pdfRaporAlt:"PDF-Übersicht aller Aufträge (ohne Beträge)",
  desktopSektorunuz:"Ihre Branche",desktopSektorSecin:"Branche wählen…",dunyaSaatleriKisa:"🌍 Weltzeituhren",
  piyasaCanli:"💱 Live-Kurse",piyasaCevrimdisi:"offline",piyasaYukleniyor:"Marktdaten werden geladen…",
  selamSabah:"Guten Morgen",altSabah:"Früh in den Tag zu starten tut gut.",
  selamOgle:"Guten Tag",altOgle:"Mitten am Tag — wie läuft's?",
  selamAksam:"Guten Abend",altAksam:"Zeit, den Tag abzuschließen.",
  selamGece:"Gute Nacht",altGece:"Noch spät bei der Arbeit.",
};
const FR2 = {
  ustaIslerim:"Mes chantiers",ustaHarcama:"Dépenses",ustaBitenler:"Terminés",ustaHesabim:"Mon compte",
  ustaAktifIsim:"Chantiers actifs",ustaBugunku:"Aujourd'hui",ustaBitirdigim:"Terminés",
  ustaBosIs:"Aucun chantier ouvert ne vous est assigné pour le moment. Il apparaîtra ici dès que votre employeur vous en attribuera un. 💪",
  ustaBosBiten:"Aucun chantier terminé pour l'instant — il apparaîtra ici dès que vous en aurez achevé un.",
  rozetCirak:"Apprenti",rozetBronz:"Pro Bronze",rozetGumus:"Pro Argent",rozetAltin:"Pro Or",rozetElmas:"Pro Diamant",
  rozetTamamladin:"{n} chantiers terminés",rozetSonraki:"Suivant",
  statBuHafta:"Cette semaine",statBuAy:"Ce mois-ci",statToplam:"Total",statTamamlanan:"Terminés",
  gununSozuBaslik:"Citation du jour",
  soz1:"Le savoir-faire, c'est bien faire le travail à chaque fois, pas une seule fois.",
  soz2:"La trace que tu laisses aujourd'hui devient ta réputation demain.",
  soz3:"Un bon artisan laisse parler son travail, pas ses outils.",
  soz4:"Les petits travaux soignés bâtissent une grande confiance.",
  soz5:"Le métier vient de la patience, la maîtrise de la répétition.",
  soz6:"Chaque chantier terminé est une référence pour le suivant.",
  soz7:"Un travail propre laisse un nom propre.",
  soz8:"La meilleure publicité est le sourire d'un client satisfait.",
  soz9:"Le soin apporté aux détails, c'est ce qui te fait remarquer.",
  soz10:"Aujourd'hui encore, tu apportes la sérénité à un foyer.",
  pdfRaporBaslik:"Télécharger mon rapport de chantiers",pdfRaporAlt:"Résumé PDF de tous les chantiers (sans montants)",
  desktopSektorunuz:"Votre secteur d'activité",desktopSektorSecin:"Choisir un secteur…",dunyaSaatleriKisa:"🌍 Heures dans le monde",
  piyasaCanli:"💱 Marché en direct",piyasaCevrimdisi:"hors ligne",piyasaYukleniyor:"Chargement du marché…",
  selamSabah:"Bonjour",altSabah:"Bien commencer la journée fait du bien.",
  selamOgle:"Bon après-midi",altOgle:"En plein milieu de journée — comment ça va ?",
  selamAksam:"Bonsoir",altAksam:"L'heure de conclure la journée.",
  selamGece:"Bonne nuit",altGece:"Encore au travail à cette heure tardive.",
};
const ES2 = {
  ustaIslerim:"Mis trabajos",ustaHarcama:"Gastos",ustaBitenler:"Terminados",ustaHesabim:"Mi cuenta",
  ustaAktifIsim:"Trabajos activos",ustaBugunku:"Hoy",ustaBitirdigim:"Terminados",
  ustaBosIs:"No tienes trabajos abiertos asignados ahora mismo. Aparecerán aquí en cuanto tu empleador te asigne uno. 💪",
  ustaBosBiten:"Aún no hay trabajos terminados — aparecerán aquí en cuanto completes el primero.",
  rozetCirak:"Aprendiz",rozetBronz:"Profesional Bronce",rozetGumus:"Profesional Plata",rozetAltin:"Profesional Oro",rozetElmas:"Profesional Diamante",
  rozetTamamladin:"{n} trabajos completados",rozetSonraki:"Siguiente",
  statBuHafta:"Esta semana",statBuAy:"Este mes",statToplam:"Total",statTamamlanan:"Completados",
  gununSozuBaslik:"Frase del día",
  soz1:"La maestría es hacer el trabajo bien cada vez, no solo una vez.",
  soz2:"La huella que dejas hoy es tu nombre mañana.",
  soz3:"Un buen profesional deja que su trabajo hable, no sus herramientas.",
  soz4:"Los trabajos pequeños hechos con esmero generan gran confianza.",
  soz5:"El oficio viene de la paciencia; la maestría, de la repetición.",
  soz6:"Cada trabajo terminado es una referencia para el siguiente.",
  soz7:"Un trabajo limpio deja un nombre limpio.",
  soz8:"La mejor publicidad es la sonrisa de un cliente satisfecho.",
  soz9:"El cuidado que pones en los detalles es lo que te hace destacar.",
  soz10:"Hoy también llevas tranquilidad a un hogar.",
  pdfRaporBaslik:"Descargar mi informe de trabajos",pdfRaporAlt:"Resumen en PDF de todos los trabajos (sin importes)",
  desktopSektorunuz:"Su sector de actividad",desktopSektorSecin:"Elegir un sector…",dunyaSaatleriKisa:"🌍 Horas del mundo",
  piyasaCanli:"💱 Mercado en vivo",piyasaCevrimdisi:"sin conexión",piyasaYukleniyor:"Cargando datos del mercado…",
  selamSabah:"Buenos días",altSabah:"Empezar el día temprano sienta bien.",
  selamOgle:"Buenas tardes",altOgle:"En medio del día — ¿cómo va todo?",
  selamAksam:"Buenas tardes",altAksam:"Hora de cerrar el día.",
  selamGece:"Buenas noches",altGece:"Todavía trabajando a esta hora tan tardía.",
};
const IT2 = {
  ustaIslerim:"I miei lavori",ustaHarcama:"Spese",ustaBitenler:"Completati",ustaHesabim:"Il mio account",
  ustaAktifIsim:"Lavori attivi",ustaBugunku:"Oggi",ustaBitirdigim:"Completati",
  ustaBosIs:"Al momento non ti sono stati assegnati lavori aperti. Appariranno qui non appena il tuo datore te ne assegnerà uno. 💪",
  ustaBosBiten:"Ancora nessun lavoro completato — apparirà qui appena ne finirai uno.",
  rozetCirak:"Apprendista",rozetBronz:"Professionista Bronzo",rozetGumus:"Professionista Argento",rozetAltin:"Professionista Oro",rozetElmas:"Professionista Diamante",
  rozetTamamladin:"{n} lavori completati",rozetSonraki:"Successivo",
  statBuHafta:"Questa settimana",statBuAy:"Questo mese",statToplam:"Totale",statTamamlanan:"Completati",
  gununSozuBaslik:"Frase del giorno",
  soz1:"L'abilità è fare il lavoro bene ogni volta, non solo una.",
  soz2:"L'impronta che lasci oggi diventa il tuo nome domani.",
  soz3:"Un buon artigiano lascia parlare il lavoro, non gli attrezzi.",
  soz4:"I piccoli lavori fatti con cura costruiscono grande fiducia.",
  soz5:"Il mestiere viene dalla pazienza, la maestria dalla ripetizione.",
  soz6:"Ogni lavoro completato è un riferimento per il prossimo.",
  soz7:"Un lavoro pulito lascia un nome pulito.",
  soz8:"La migliore pubblicità è il sorriso di un cliente soddisfatto.",
  soz9:"La cura che metti nei dettagli è ciò che ti fa notare.",
  soz10:"Anche oggi porti serenità in una casa.",
  pdfRaporBaslik:"Scarica il mio report lavori",pdfRaporAlt:"Riepilogo PDF di tutti i lavori (senza importi)",
  desktopSektorunuz:"Il tuo settore",desktopSektorSecin:"Scegli un settore…",dunyaSaatleriKisa:"🌍 Orari nel mondo",
  piyasaCanli:"💱 Mercato in tempo reale",piyasaCevrimdisi:"offline",piyasaYukleniyor:"Caricamento dati di mercato…",
  selamSabah:"Buongiorno",altSabah:"Iniziare presto la giornata fa bene.",
  selamOgle:"Buon pomeriggio",altOgle:"A metà giornata — come va?",
  selamAksam:"Buonasera",altAksam:"Ora di chiudere la giornata.",
  selamGece:"Buonanotte",altGece:"Ancora al lavoro a quest'ora tarda.",
};
const PT2 = {
  ustaIslerim:"Meus trabalhos",ustaHarcama:"Despesas",ustaBitenler:"Concluídos",ustaHesabim:"Minha conta",
  ustaAktifIsim:"Trabalhos ativos",ustaBugunku:"Hoje",ustaBitirdigim:"Concluídos",
  ustaBosIs:"No momento não há trabalhos em aberto atribuídos a você. Assim que seu empregador atribuir um, ele aparecerá aqui. 💪",
  ustaBosBiten:"Ainda não há trabalhos concluídos — aparecerão aqui assim que você terminar o primeiro.",
  rozetCirak:"Aprendiz",rozetBronz:"Profissional Bronze",rozetGumus:"Profissional Prata",rozetAltin:"Profissional Ouro",rozetElmas:"Profissional Diamante",
  rozetTamamladin:"{n} trabalhos concluídos",rozetSonraki:"Próximo",
  statBuHafta:"Esta semana",statBuAy:"Este mês",statToplam:"Total",statTamamlanan:"Concluídos",
  gununSozuBaslik:"Frase do dia",
  soz1:"Ofício é fazer o trabalho certo todas as vezes, não só uma.",
  soz2:"A marca que você deixa hoje é o seu nome amanhã.",
  soz3:"Um bom profissional deixa o trabalho falar, não as ferramentas.",
  soz4:"Pequenos trabalhos feitos com cuidado constroem grande confiança.",
  soz5:"O ofício vem da paciência; a maestria, da repetição.",
  soz6:"Cada trabalho concluído é uma referência para o próximo.",
  soz7:"Trabalho limpo deixa nome limpo.",
  soz8:"A melhor propaganda é o sorriso de um cliente satisfeito.",
  soz9:"O cuidado que você dá aos detalhes é o que faz as pessoas notarem.",
  soz10:"Hoje você também está levando tranquilidade a uma casa.",
  pdfRaporBaslik:"Baixar meu relatório de trabalhos",pdfRaporAlt:"Resumo em PDF de todos os trabalhos (sem valores)",
  desktopSektorunuz:"Seu setor de atuação",desktopSektorSecin:"Escolher um setor…",dunyaSaatleriKisa:"🌍 Horários mundiais",
  piyasaCanli:"💱 Mercado ao vivo",piyasaCevrimdisi:"offline",piyasaYukleniyor:"Carregando dados do mercado…",
  selamSabah:"Bom dia",altSabah:"Começar o dia cedo faz bem.",
  selamOgle:"Boa tarde",altOgle:"No meio do dia — como estão as coisas?",
  selamAksam:"Boa noite",altAksam:"Hora de encerrar o dia.",
  selamGece:"Boa noite",altGece:"Ainda trabalhando a esta hora tardia.",
};
const NL2 = {
  ustaIslerim:"Mijn klussen",ustaHarcama:"Uitgaven",ustaBitenler:"Voltooid",ustaHesabim:"Mijn account",
  ustaAktifIsim:"Actieve klussen",ustaBugunku:"Vandaag",ustaBitirdigim:"Voltooid",
  ustaBosIs:"Je hebt momenteel geen toegewezen openstaande klussen. Zodra je werkgever er een toewijst, verschijnt die hier. 💪",
  ustaBosBiten:"Nog geen voltooide klussen — ze verschijnen hier zodra je je eerste klus afrondt.",
  rozetCirak:"Leerling",rozetBronz:"Brons-vakman",rozetGumus:"Zilver-vakman",rozetAltin:"Goud-vakman",rozetElmas:"Diamant-vakman",
  rozetTamamladin:"{n} klussen voltooid",rozetSonraki:"Volgende",
  statBuHafta:"Deze week",statBuAy:"Deze maand",statToplam:"Totaal",statTamamlanan:"Voltooid",
  gununSozuBaslik:"Citaat van de dag",
  soz1:"Vakmanschap is het werk elke keer goed doen, niet maar één keer.",
  soz2:"Het spoor dat je vandaag achterlaat, is morgen je naam.",
  soz3:"Een goede vakman laat het werk spreken, niet het gereedschap.",
  soz4:"Kleine klussen met zorg gedaan bouwen groot vertrouwen op.",
  soz5:"Vakmanschap komt van geduld, meesterschap van herhaling.",
  soz6:"Elke afgeronde klus is een referentie voor de volgende.",
  soz7:"Netjes werk laat een nette naam achter.",
  soz8:"De beste reclame is de glimlach van een tevreden klant.",
  soz9:"De zorg die je aan details besteedt, is wat opvalt.",
  soz10:"Ook vandaag breng je rust in een huis.",
  pdfRaporBaslik:"Mijn klussenrapport downloaden",pdfRaporAlt:"PDF-overzicht van alle klussen (zonder bedragen)",
  desktopSektorunuz:"Uw sector",desktopSektorSecin:"Kies een sector…",dunyaSaatleriKisa:"🌍 Wereldklokken",
  piyasaCanli:"💱 Live markt",piyasaCevrimdisi:"offline",piyasaYukleniyor:"Marktgegevens laden…",
  selamSabah:"Goedemorgen",altSabah:"Vroeg beginnen aan de dag voelt goed.",
  selamOgle:"Goedemiddag",altOgle:"Midden op de dag — hoe gaat het?",
  selamAksam:"Goedenavond",altAksam:"Tijd om de dag af te ronden.",
  selamGece:"Goedenacht",altGece:"Nog steeds aan het werk op dit late uur.",
};
Object.assign(TR,TR2);Object.assign(EN,EN2);Object.assign(DE,DE2);Object.assign(FR,FR2);
Object.assign(ES,ES2);Object.assign(IT,IT2);Object.assign(PT,PT2);Object.assign(NL,NL2);
...
export const getT = (dil) => {
  ...
  return EN; // bilinmeyen/eski dil kodu → İngilizce
};
