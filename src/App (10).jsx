if(typeof window!=="undefined")console.log("%c🚀 TradeFlow build: v20260707-hatirla","background:#2563EB;color:#fff;padding:4px 10px;border-radius:6px;font-weight:bold;");
