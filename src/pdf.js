// ═══ PDF / RAPOR ÜRETİCİLERİ ═══
// Bu dosya jsPDF + Türkçe font (~300 KB) içerir ve SADECE kullanıcı bir rapor
// istediğinde dinamik olarak yüklenir. Böylece uygulamanın ilk açılışı hızlanır.
import jsPDF from "jspdf";
import autoTable from "jspdf-autotable";
import { FONT_TR, FONT_TR_BOLD } from "./fontTR.js";
import { fmt, SEMBOL, KURLAR, AKTIF_PARA } from "./utils.js";
